...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.MyHolder> {
    ...
    public CartAdapter(Context context, ArrayList<CartList> arrayList) {
        ...
        db = context.openOrCreateDatabase("Internship", Context.MODE_PRIVATE, null);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.deleteIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CartFragment.iTotalPrice -= Integer.parseInt(arrayList.get(position).totalPrice);
        ...
        holder.remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {int iQty = Integer.parseInt(arrayList.get(position).getProductQty())+1;
                iQty = Integer.parseInt(arrayList.get(position).getProductQty()) - 1;
                int iTotalPrice = Integer.parseInt(arrayList.get(position).getProductPrice()) * iQty;
